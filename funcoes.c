...
void submenuprodutos(estprod **produto, int *contador)
{
    ...
    while (1)
    {
        ...
        case 4:
            ...
            break;
        case 5:
            //salvarprodutoscsv(&produto, contador);
        ...
        switch(opc){
            ...
            /*break;
            case 2:
            lerprodutoscsv(produto, contador);
            break;
           default:
        ...
        else // se o código for diferente de 0
        {
            ...
            else // se o retorno for diferente de -1
            {
                ...
                if (quantidade <= produto[indice]->quantestoque && quantidade > 0) // se a quantidade desejada for menor ou igual a quantidade em estoque e maior que 0
                {
                    ...
                    printf("subtotal e %f", subtotal);
                    
                    total += subtotal;                                // soma o sub ao total
                    printf("total e %f", total);
...
/*void salvarprodutoscsv(estprod **produto, int *contador)
{
    FILE *fp;
...
void lerprodutoscsv(estprod **produto, int *contador)
{
    FILE *fp;
    fp = fopen("produtos.csv", "r");
    ...
    {
        printf("Arquivo CSV aberto com sucesso.\n");
    }
    ...
    *contador = 0;
    ...
    while (fscanf(fp, "%d,%25[^,],%f,%d,%d,%d\n", &temporaria.codigo, temporaria.nome, &temporaria.preco, &temporaria.quantestoque, &temporaria.quantvendida, &temporaria.quantvendidacupom) == 6)
    {
        if (*contador == 0)
        {
            *produto = (estprod *)malloc(sizeof(estprod));
